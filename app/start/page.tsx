      ...
      <div className="mx-auto w-full max-w-7xl">
        ...
        <section className="mx-auto mt-12 max-w-4xl text-center sm:mt-16">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-pretty text-base leading-7 text-text-secondary sm:text-lg sm:leading-8">
            Personal finance, independent work, retail, small business, and enterprise operations
            use one secure identity while keeping every workspace and dataset separate.
          </p>
        </section>
        ...
        <section
          ...
          aria-label="Available JALVORO experiences"
        >
        ...
        <section className="mx-auto mt-10 flex max-w-4xl items-start gap-3 rounded-[var(--radius-card)] bg-surface-secondary p-5 text-sm leading-6 text-text-secondary sm:p-6">
          ...
          <p>
            Choosing an experience does not create a second account. In the future, the same
            verified email can add another JALVORO workspace or accept an organization invitation
            without merging the underlying records.
          </p>
        </section>
      </div>
    </main>
