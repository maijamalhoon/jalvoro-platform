-- Route every Command Center database operation through a dual-project,
-- AAL2-verified Edge Function. Normal authenticated clients lose direct RPC
-- execution; the gateway preserves the verified main-project actor in audit logs.
  ...
  case v_operation
    ...
    when 'apply_billing_plan_operation' then
      return public.apply_billing_plan_operation(
        ...
        coalesce((v_arguments->>'p_currency_exponent')::smallint, 2),
