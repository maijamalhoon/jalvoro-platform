        ...
        <p className="flex min-h-9 items-center gap-2 text-xs font-semibold sm:text-sm">
          ...
          <span>
            ...
            <span className="text-text-secondary">
              No payment required. Homepage figures are illustrative.
            </span>
          </span>
        </p>
...
export function LaunchLegalRail() {
  return (
    <section
      className="border-t border-border/70 bg-background text-text-secondary"
      aria-label="Current access terms and public trust links"
    >
      <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-4 px-4 py-5 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
        <p className="flex items-start gap-2 text-xs leading-5 sm:text-sm">
          ...
          />
          <span>
            Free access is the only active public plan. Paid pricing and payment
            collection are not advertised.
          </span>
        </p>
        ...
        >
          ...
          <Link
            className="finance-focus hover:text-text-primary"
            href="/disclosures"
          >
            Disclosures
          </Link>
